...
SELECT u.athlete_id, 
	MIN(IF(season_round = 1, team_id, NULL)) AS round1_team_id, 
	MAX(IF(season_round = 2, team_id, NULL)) AS round2_team_id, 
	MIN(IF(season_round = 1, position, NULL)) AS round1_position, 
	MAX(IF(season_round = 2, position, NULL)) AS round2_position
FROM lineups u
...
ORDER BY u.athlete_id ASC
	 ...
	 * @param int $leagueId
	 * @param int $round		1 = Hinrunde, 2 = Rueckrunde, sonst alles
